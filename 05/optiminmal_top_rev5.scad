...
TOP_PLATE_FILE = "/Users/broden/dev/keyboards/optiminimal/05/top_plate_rev5.dxf";
...
module bottomCase() {
  ...
  difference() {
    ...
    union() {
      ...
      translate([2.2, 2.2, caseThickness-4]) linear_extrude (width=0,height=4) import ("/Users/broden/dev/3dmodels/keyboards/id3/05/top_plate_rev5");
    }
