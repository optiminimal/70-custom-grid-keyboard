...
TOP_PLATE_FILE = "top_plate_rev5.dxf";
...
module screwNozzle(x, y) {
  difference() {
    translate([x, y, 0]) cylinder(h=caseThickness-(plateThickness), r1=2.1, r2=1.4);
    translate([x, y, plateThickness]) cylinder(h=plateThickness, r=mountingholeradius-0.2, $fn=24);
